...
void UFLCharStatAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    ...
    DOREPLIFETIME_CONDITION_NOTIFY(UFLCharStatAttributeSet, CriticalRate, COND_None, REPNOTIFY_Always);
    DOREPLIFETIME_CONDITION_NOTIFY(UFLCharStatAttributeSet, CriticalMultiplier, COND_None, REPNOTIFY_Always);
...
void UFLCharStatAttributeSet::OnRep_CriticalRate(const FGameplayAttributeData& OldValue)
{
    GAMEPLAYATTRIBUTE_REPNOTIFY(UFLCharStatAttributeSet, CriticalRate, OldValue);
}

void UFLCharStatAttributeSet::OnRep_CriticalMultiplier(const FGameplayAttributeData& OldValue)
{
    GAMEPLAYATTRIBUTE_REPNOTIFY(UFLCharStatAttributeSet, CriticalMultiplier, OldValue);
}
