...
UCLASS(Abstract)
class FIRSTLIGHT_API AFirstLightCharacterBase : public ACharacter, public IAbilitySystemInterface, public ICombatInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	AFirstLightCharacterBase(const class FObjectInitializer& ObjectInitializer);
	...
	EFLHitReactDirection GetHitReactDirection(const FVector& ImpactPoint);
